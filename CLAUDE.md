...
- LLM とやりとりをする処理は、**必ず**`/api/llm` エンドポイントをつかって実装すること
- 
## 絶対ルール
...
## デプロイ
- main ブランチに push を行うと自動的に Vercel にデプロイされる。
- Vercel の URL は `https://fuji-prototype-5oxe3g7pa-ryugo-9039s-projects.vercel.app/`
- ユーザから、「デプロイ」や「本番に反映」など、Vercel に反映すると思わせるような指示があった場合は、main ブランチに push し、デプロイの完了まで確認すること
- デプロイ後は、`https://fuji-prototype-5oxe3g7pa-ryugo-9039s-projects.vercel.app/` を表示し、ここにアクセスすることで確認できる旨を出力すること
